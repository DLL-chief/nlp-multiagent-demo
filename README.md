...
- [Открыть в Google Colab](https://colab.research.google.com/drive/14E6ClXNadnVnLWpUMW1zy4ZAdBlazPk3?usp=sharing)  
  _Рекомендуется для быстрого знакомства и тестирования логики системы. Все проверки работают "из коробки", только потребуется токен Telegram-бота и (при необходимости) собственные бесплатные два ngrok-ключа._
...
- Для вопросов, обратной связи: [tg: @d_strygin](https://t.me/d_strygin)
